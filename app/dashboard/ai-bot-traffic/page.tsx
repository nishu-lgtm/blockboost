...
// Colour class pairs keyed by bot name — purely visual, no logic attached.
  ...
  return (
    <div className="flex flex-col min-h-full">
      <Topbar
        ...
        description="AI crawlers that have visited your tracked URLs"
      />
              ...
              <div className="flex flex-wrap gap-3">
                {botCounts.map((b) => (
                  ...
                  >
                    <Badge
                      variant="outline"
                      className={botBadgeClass(b.botName)}
                    >
                      {b.botName}
                    </Badge>
          ...
          <CardContent className="p-0">
            {recentVisits.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-slate-400 gap-3">
                ...
                <p className="text-sm">No bot visits recorded yet.</p>
                <p className="text-xs max-w-sm text-center">
                  Install the tracking snippet on your site — bot visits will appear here as AI crawlers detect your content.
                </p>
              </div>
            ) : (
